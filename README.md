...
* **Chancay Rodriguez Oscar Emilio** → Desarrollo del Módulo de Usuarios y Clientes [RF01 - RF03].
* **López Ortiz Karen Koraima** → Desarrollo del Módulo de Habitaciones y Disponibilidad [RF04 - RF05].
* **Zambrano Infante Ángel Alejandro** → Desarrollo del Módulo de Reservas y Check-in/out [RF06 - RF09].
...
## Esquema de Arquitectura (DDS - Tarea 02.02)
